...
<body>
    <div class="page-header">
		...
		<div style="width:100%;heigth:300px;background-color:#ADADAD">
			...
			$result = mysqli_query($link,"SELECT * FROM aanvragen WHERE vrijwilliger='$current_user' ORDER BY datum" );
			...
			echo "</table>";
			echo "<form action='canceltaak.php' method='post'>";
			echo "<input type='submit' class='btn btn-primary' name='".$row['id']."' value='Cancel taak' style='position:absolute;bottom:40px;left:60px; transform: rotate(-3deg);'>";
			echo "</form>";
			echo "</div>";
			}
    ...
    <p>
		<a href="index.php" class="btn btn-primary">Zie open aanvragen</a>
